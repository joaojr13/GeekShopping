...
namespace GeekShopping.Web.Utils
{
    ...
    {
        private static MediaTypeHeaderValue _contentType = MediaTypeHeaderValue.Parse("application/json");
        ...
        public static async Task<T> ReadContentAsync<T>(this HttpResponseMessage response)
        {
            ...
            return JsonSerializer.Deserialize<T>(dataAsString, options: new JsonSerializerOptions { PropertyNameCaseInsensitive = true });
